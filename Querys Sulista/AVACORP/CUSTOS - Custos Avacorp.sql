...
AND notafiscalsimples.dtemissao >= '01/06/2026'
...
AND veiculo_marcador.agrupador = 2
AND notafiscalsimples.dtemissao >= '01/01/2023'
...
AND notafiscalentrada.dtentrada::DATE >= '01/01/2023')

SELECT * FROM custos

ORDER BY dtemissao_ordemcompra DESC