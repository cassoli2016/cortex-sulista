...
- O realizado vem do próprio CÓRTEX onde a casa já mede. Dezesseis indicadores automáticos nascem prontos: receita e contas vencidas da Visão Geral, retorno vazio e km por litro da Análise de KM, OS abertas e custo de manutenção, férias sem agendamento e CNH vencendo. Indicador automático NÃO aceita digitação — é o mesmo número que a tela do assunto mostra, e se ele está errado o conserto é na origem. A reunião passa a discutir o desvio em vez de conferir de onde veio o número.
