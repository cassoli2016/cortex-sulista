...
CONTEXTOS: dict[str, dict] = {
    ...
    "faturamento": {
        ...
        "variaveis": [
            ...
            _v("farol_dia", "Semáforo do dia anterior (🟢🟡🔴, ⚪ sem meta)", "🟡"),
            _v("farol_mes", "Semáforo do atingimento do mês", "🟡"),
            _v("titulo_mes", "MÊS ATÉ ONTEM — ou FECHAMENTO DE <MÊS> no dia 1º", "MÊS ATÉ ONTEM"),
            _v("titulo_previsao", "PREVISÃO DE FECHAMENTO — ou RESULTADO FINAL no dia 1º", "PREVISÃO DE FECHAMENTO"),
            _v("previsao_mes", "Previsão de fechamento no ritmo atual", "R$ 13.480.221,03"),
            _v("previsao_vs_meta", "Previsão × meta do mês", "-4,1% vs meta do mês"),
