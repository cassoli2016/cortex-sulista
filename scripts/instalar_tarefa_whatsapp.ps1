...
$nome = 'Cortex Sulista - WhatsApp agendado'
...
$alvo = Join-Path $repo "scripts\enviar_zap_agendados.py"
...
# esta na hora de alguma rotina. Resumo diario tem hora marcada e nao
# urgencia de minuto, entao passo menor so gastaria consulta - e passo maior
# faria o resumo das 08:00 sair as 08:29 com frequencia.
#
