# Registra a tarefa agendada da coleta de pneus da Prolog.
#
...
# mostrava pneus de 19/08 ao lado de posicoes ao vivo.
#
...
#   powershell -ExecutionPolicy Bypass -File "C:\Users\inteligencia\Documents\cortex-sulista\scripts\instalar_tarefa_pneus.ps1"
...
$gatilhos[0].Repetition = (New-ScheduledTaskTrigger -Once -At 05:10 `
